 ...
 */
#ifndef __GRID_EDITOR_4_H__
#define __GRID_EDITOR_4_H__
 ...
 */
class gridEditor_4_c : public gridEditor_c {
...
public:
  ...
  gridEditor_4_c(int x, int y, int w, int h, Puzzle * p) : gridEditor_c(x, y, w, h, p) {}
};
