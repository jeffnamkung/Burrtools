...
void beveloffset(void) {
  ...
  for (int v = 0; v < NUM_VERTICES; v++) {
    ...
    for (int i = 0; i < vfaces.size(); i++) {
      p[i] = calcPlane(
          vertices[faces[0][vfaces[i]][1]][0],
          vertices[faces[0][vfaces[i]][1]][1],
          vertices[faces[0][vfaces[i]][1]][2],
          vertices[faces[0][vfaces[i]][2]][0],
          vertices[faces[0][vfaces[i]][2]][1],
          vertices[faces[0][vfaces[i]][2]][2],
          vertices[faces[0][vfaces[i]][3]][0],
          vertices[faces[0][vfaces[i]][3]][1],
          vertices[faces[0][vfaces[i]][3]][2]);
    }
