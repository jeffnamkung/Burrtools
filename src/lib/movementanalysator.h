...
class movementAnalysator_c {
 ...
 private:
  ...
  disassemblerNode_c *newNodeMerge(const disassemblerNode_c *n0,
 ...
 public:
  ...
  void completeFind(disassemblerNode_c *searchnode,
                    const std::vector<unsigned int> &pieces,
   ...
   */
  disassemblerNode_c *findMatching(disassemblerNode_c *nd,
