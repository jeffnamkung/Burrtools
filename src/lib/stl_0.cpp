...
Polyhedron *stlExporter_0_c::getMesh(const Voxel &v,
                                     const faceList_c &holes) const {
  if (v.countState(
      Voxel::VX_VARIABLE))
  ...
  if (!v.meshParamsValid(bevel / cube_scale,
                         shrink / cube_scale))
    throw stlException_c("Bevel and offset are not valid");
...
void stlExporter_0_c::setParameter(unsigned int idx, double value) {
  switch (idx) {
    ...
    case 4: tubes = value;
      return;
    case 5: leaveGroovesInside = (value != 0);
      return;
    case 6: leaveGroovesOutside = (value != 0);
      return;
    case 7: smoothVoid = (value != 0);
      return;
    default: return;
  }
}
...
const char *stlExporter_0_c::getParameterTooltip(unsigned int idx) const {
  switch (idx) {
    ...
    case 4:
      return " The size of the tubes that connect the inner void with the outside world. "
...
stlExporter_c::parameterTypes stlExporter_0_c::getParameterType(unsigned int idx) const {
  switch (idx) {
    ...
    case 3:
    case 4:
    default:return PAR_TYP_POS_DOUBLE;
    case 5:
    case 6:
    case 7:return PAR_TYP_SWITCH;
  }
}
